...
var Course2 = /** @class */ (function () {
    function Course2(id, courseName, images, introduction, task, person, video) {
        this.id = id;
        this.courseName = courseName;
        this.images = images;
...
var community = /** @class */ (function () {
    function community(id, images, courseName, introduction, time, read, commit) {
        this.id = id;
        this.images = images;
        this.courseName = courseName;
        this.introduction = introduction;
...
app.get('/api/conmmunitys', function (req, res) {
    res.json(conmmunitys);
});
app.get('/api/conmmunitys/:id', function (req, res) {
    res.json(conmmunitys.find(function (ele) { return ele.id == req.params.id; }));
});
app.post('/api', function (req, res) {
    res.json(conmmunitys);
});
...
var task = /** @class */ (function () {
    function task(id, taskname, time, yanshou, coursename, grade) {
        this.id = id;
...
app.get('/api/tasks/:id', function (req, res) {
    res.json(tasks.find(function (ele) { return ele.id == req.params.id; }));
});
app.post('/api', function (req, res) {
    res.json(tasks);
});
//====================================================首页已完成=================================================================
var task1 = /** @class */ (function () {
    function task1(id, taskname, time, yanshou, coursename, grade) {
        this.id = id;
        this.taskname = taskname;
        this.time = time;
        this.yanshou = yanshou;
...
app.get('/api/tasks1', function (req, res) {
    res.json(tasks1);
});
app.get('/api/tasks1/:id', function (req, res) {
    res.json(tasks1.find(function (ele) { return ele.id == req.params.id; }));
});
app.post('/api', function (req, res) {
    res.json(tasks1);
});
//====================================================首页已完成=================================================================
var joinc = /** @class */ (function () {
    function joinc(id, img, coursename, task, person) {
        this.id = id;
        this.img = img;
        this.coursename = coursename;
        this.task = task;
...
app.get('/api/joincs', function (req, res) {
    res.json(joincs);
});
app.get('/api/joincs/:id', function (req, res) {
    res.json(joincs.find(function (ele) { return ele.id == req.params.id; }));
});
app.post('/api', function (req, res) {
    res.json(joincs);
});
...
var study = /** @class */ (function () {
    function study(id, img, coursename, introduction, keshi, person) {
        this.id = id;
        this.img = img;
        this.coursename = coursename;
        this.introduction = introduction;
...
app.get('/api/studys', function (req, res) {
    res.json(studys);
});
app.get('/api/studys/:id', function (req, res) {
    res.json(studys.find(function (ele) { return ele.id == req.params.id; }));
});
app.post('/api', function (req, res) {
    res.json(studys);
});
